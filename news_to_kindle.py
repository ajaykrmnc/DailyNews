...
def fetch_and_convert_to_html():
    ...
    # Optional filters
    exclude_classes = ["border-bg", "tags-new", "mobile-ad-banner", "desktop-ad-banner", "starRating", "social-shares", "next-post"]   # divs to discard

    for div in content_div.find_all("div"):
        if div and div.get("class") and any(cls in div.get("class") for cls in exclude_classes):
            div.decompose()
        else:
            pass
    ...
    for a in content_div.find_all("a"):     
        a["style"] = "text-decoration: none; color: inherit; pointer-events: none;"
        a["href"] = "#"
